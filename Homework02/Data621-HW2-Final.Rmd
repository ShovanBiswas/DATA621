...
```{r echo=F, message=F}
#read in the data
data <- read.csv("https://raw.githubusercontent.com/ShovanBiswas/DATA621/master/Homework02/classification-output-data.csv", stringsAsFactors = FALSE)
```
