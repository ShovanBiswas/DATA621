...
```{r, message=FALSE, warning=FALSE, echo=FALSE}
training <- read.csv('https://raw.githubusercontent.com/ShovanBiswas/DATA621/master/Homework03/crime-training-data_modified.csv')
training2 <- training # for melting and boxploting
evaluation <- read.csv('https://raw.githubusercontent.com/ShovanBiswas/DATA621/master/Homework03/crime-evaluation-data_modified.csv')
