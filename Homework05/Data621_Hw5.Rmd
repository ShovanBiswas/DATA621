...
data_train <- read_csv("https://raw.githubusercontent.com/ShovanBiswas/DATA621/master/Homework05/wine-training-data.csv") %>%
  dplyr::select(TARGET, everything())
data_eval <- read_csv("https://raw.githubusercontent.com/ShovanBiswas/DATA621/master/Homework05/wine-evaluation-data.csv")
```
...
grid.arrange(p_t_m,p_e_m, p_t_dt,p_e_dt,ncol = 2, widths = c(1,1), heights = c(1.5,1), top = 'Missing Values and Data Type Check')
